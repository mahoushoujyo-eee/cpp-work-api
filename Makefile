...
clean:
	...
	rm -rf $(BUILD_DIR)
	rm -f $(SERVER_TARGET) $(STATIC_SERVER_TARGET) $(STATIC_SERVER_TARGET)-full
...
help:
	...
	@echo "  all               - Build server program"
	@echo "  static            - Build semi-static version (C++ runtime statically linked)"
	@echo "  static-full       - Build fully static version (may fail without static libs)"
	...
	@echo "  memcheck          - Run memory leak detection on server"
	@echo "  help              - Show this help message"

# Phony targets
.PHONY: all static static-full clean rebuild install-deps install-static-deps setup-db run-server dev format analyze memcheck help
